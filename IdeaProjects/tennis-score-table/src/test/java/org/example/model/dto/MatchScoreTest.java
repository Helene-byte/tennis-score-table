...
class MatchScoreTest {
    ...
    void testTieBreakWin() {
        ...
        scoreService.pointWon(score, 1); // 7-5, игрок 1 выигрывает сет
    ...
    void testMatchFinish() {
        ...
        setPoints(RegularGamePoints.FORTY, RegularGamePoints.LOVE);
        scoreService.pointWon(score, 1); // игрок 1 выигрывает гейм, а значит и сет, а значит и матч
